...
top_list = drive.ListFile({'q': "'12s15VMURjn-GXtU-RtlwXQA0V-0qM1iY' in parents and trashed=false"}).GetList()

for i in tqdm(glob.glob(f'./finetuned_stable_diffusion_outpainting3/{args.folder}/outpainted_images3blended/*')):
