...
top_list = drive.ListFile({'q': "'1zahEq31-jUg-vYxH8SOlQAfWjJJZk4Qa' in parents and trashed=false"}).GetList()

for i in tqdm(glob.glob(f'./finetuned_stable_diffusion_outpainting2/{args.folder}/outpainted_images3blended/*')):
