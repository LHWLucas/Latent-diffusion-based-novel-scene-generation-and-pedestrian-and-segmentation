...
top_list = drive.ListFile({'q': "'1lUgXK33Kd22q7ZSlYZ8d3Ep7dntFRaFl' in parents and trashed=false"}).GetList()

for i in tqdm(glob.glob(f'./base_stable_diffusion_finetuned/{args.folder}/outpainted_images3blended/*')):
